...
bool srvCallback(erasers_nav_msgs::GetRobotPose::Request &req, erasers_nav_msgs::GetRobotPose::Response &res)
{
...
int main(int argc, char** argv)
{
  ...
  ros::ServiceServer service = nh.advertiseService("/erasers/navigation/mapping_pose_srv", srvCallback);
