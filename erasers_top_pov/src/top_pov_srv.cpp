...
bool srvCallback(erasers_nav_msgs::GetProjectedView::Request &req, erasers_nav_msgs::GetProjectedView::Response &res)
{
...
int main(int argc, char** argv)
{
  ...
  ros::ServiceServer service = nh.advertiseService("/erasers/navigation/top_pov_srv", srvCallback);
