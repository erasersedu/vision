...
{
  //Server parameters
  erasers_nav_msgs::GetOccupancyPOVMap srv;
  ///////////
  ...
  ros::ServiceClient client = nh.serviceClient<erasers_nav_msgs::GetOccupancyPOVMap>("/erasers/navigation/top_pov2map_srv");
