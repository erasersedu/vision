...
// erasers headers
#include <erasers_nav_msgs/OccupancyMap.h>
#include <erasers_nav_msgs/GetOccupancyMap.h>

#include <erasers_nav_msgs/OccupancyPOVMap.h>
#include <erasers_nav_msgs/GetOccupancyPOVMap.h>

#include <erasers_nav_msgs/ProjectedView.h>
#include <erasers_nav_msgs/GetProjectedView.h>

#include <erasers_nav_msgs/RobotPose.h>
#include <erasers_nav_msgs/GetRobotPose.h>
...
erasers_nav_msgs::GetProjectedView srv_pov;
erasers_nav_msgs::GetOccupancyMap srv_map;
erasers_nav_msgs::GetRobotPose srv_pose;
...
bool srvCallback(erasers_nav_msgs::GetOccupancyPOVMap::Request &req, erasers_nav_msgs::GetOccupancyPOVMap::Response &res)
{
...
int main(int argc, char** argv)
{
  ...
  ros::ServiceServer service = nh.advertiseService("/erasers/navigation/top_pov2map_srv", srvCallback);

  ROS_INFO_STREAM("Subscribing to /erasers/navigation/mapping_pose_srv ...");
  client_pose = nh2.serviceClient<erasers_nav_msgs::GetRobotPose>("/erasers/navigation/mapping_pose_srv");

  ROS_INFO_STREAM("Subscribing to /erasers/navigation/top_pov_srv ...");
  client_pov = nh3.serviceClient<erasers_nav_msgs::GetProjectedView>("/erasers/navigation/top_pov_srv");

  ROS_INFO_STREAM("Subscribing to /erasers/navigation/top_map_srv ...");
  client_map = nh4.serviceClient<erasers_nav_msgs::GetOccupancyMap>("/erasers/navigation/top_map_srv");
