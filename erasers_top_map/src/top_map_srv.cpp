...
bool srvCallback(erasers_nav_msgs::GetOccupancyMap::Request &req, erasers_nav_msgs::GetOccupancyMap::Response &res)
{
...
int main(int argc, char** argv)
{
  ...
  ros::ServiceServer service = nh.advertiseService("/erasers/navigation/top_map_srv", srvCallback);
